...
\begin{tikzpicture}[x=1.2cm, y=1.2cm]
  ...
  \node at(0, 0)   {\particle[gray!20!white]
                   {$S$}        {up}       {$2.3$ MeV}{1/2}{$2/3$}{R/G/B}};
  \node at(0,-1)   {\particle[gray!20!white]
                   {$A$}        {down}    {$4.8$ MeV}{1/2}{$-1/3$}{R/G/B}};
  \node at(0,-2)   {\particle[gray!20!white]
                   {$R$}        {electron}       {$511$ keV}{1/2}{$-1$}{}};
  
  
  \node at(1, 0)   {\particle
                   {$l$}        {charm}   {$1.28$ GeV}{1/2}{$2/3$}{R/G/B}};
  \node at(1,-1)   {\particle 
                   {$b$}        {strange}  {$95$ MeV}{1/2}{$-1/3$}{R/G/B}};
  \node at(1,-2)   {\particle
                   {$e$}      {muon}         {$105.7$ MeV}{1/2}{$-1$}{}};
  \node at(3,-2)   {\particle
                   {$o$}  {$\mu$ neutrino}    {$<190$ keV}{1/2}{}{}};
  \node at(2, 0)   {\particle
                   {$y$}        {top}    {$173.2$ GeV}{1/2}{$2/3$}{R/G/B}};
  \node at(2,-1)   {\particle
                   {$s$}        {bottom}  {$4.7$ GeV}{1/2}{$-1/3$}{R/G/B}};
  \node at(2,-2)   {\particle
                   {$p$}     {tau}          {$1.777$ GeV}{1/2}{$-1$}{}};
